...
from libgreader import GoogleReader, Feed, ItemsContainer, Item, BaseFeed, SpecialFeed, ReaderUrl
from libgreader import SuperAuthMethod as ClientAuthMethod
import re
import time
...
class TestClientAuthMethod(unittest.TestCase):
    ...
    def test_reader_user_info(self):
        ...
        self.assertEqual(username, info['userEmail'])
